...
advertisement version: 2
Protocol Hello:  OUI=0x00000C, Protocol ID=0x0112; payload len=27, value=00000000FFFFFFFF010221FF000000000000001FC981A380FF0000
VTP Management Domain: 'AH'
Native VLAN: 14
Duplex: full
Management address(es): 
  IP address: 10.240.14.3
...
combination of devices, IP phone and switch in this example.
Need: Device ID (AH1CMSW07 or SEP001F9EAB59F1)
the platform: (WS-C3560-24PS)
the software version: (12.2(44)SE2)'''
